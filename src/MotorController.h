 ...
 * @ Modified time: 2022-02-16 10:15:55
 * @ Description:
 */
...
public:
    ...
    // Methods
    void init(uint8_t motor_no, uint8_t motor_BRAKE_pin, uint8_t motor_DIRECTION_pin, uint8_t motor_PWM_pin, uint8_t motor_ENCODER_pin, uint16_t frequency, uint16_t resolution, int flip_dir);
    void drive(int8_t dir, uint16_t motorSpeed);
    void motorEnable(int pin, int hilo);
    void stop();
    void readEncoder();
